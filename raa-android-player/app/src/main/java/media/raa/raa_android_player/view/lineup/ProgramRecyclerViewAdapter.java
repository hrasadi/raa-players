...
public class ProgramRecyclerViewAdapter extends RecyclerView.Adapter<ProgramRecyclerViewAdapter.ViewHolder> {
    ...
    /**
     * {@link RecyclerView.Adapter} that can display a {@link media.raa.raa_android_player.model.lineup.lineup.Program} and makes a call to the
     * specified {@link LineupFragment.LineupFragment.OnListFragmentInteractionListener}.
     */
    @SuppressWarnings("WeakerAccess")
    public static class ProgramRecyclerViewAdapter extends RecyclerView.Adapter<ProgramRecyclerViewAdapter.ViewHolder> {

        private final List<media.raa.raa_android_player.model.lineup.lineup.Program> mValues;
        private final LineupFragment.LineupFragment.OnListFragmentInteractionListener mListener;

        public ProgramRecyclerViewAdapter(media.raa.raa_android_player.model.lineup.lineup.Lineup lineup, LineupFragment.LineupFragment.OnListFragmentInteractionListener listener) {
            mValues = lineup.getCurrentLineup();
            mListener = listener;
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public final TextView mProgramNameView;
            public final TextView mProgramClipsView;
            public media.raa.raa_android_player.model.lineup.lineup.Program mItem;
